...
public class ProcessadorDeMensagemDeConsumo implements ProcessadorMensagem{
    ...
    public ProcessadorDeMensagemDeConsumo() {
    ...
    public NotificacaoErro processarMensagem(Mensagem mensagem, OrdemProducao ordemProducao, ValidadorMensagem validadorMensagem) {
        ...
        String idMateriaPrima=mensagemConsumo.idMateriaPrima;
        NotificacaoErro notificacaoErro=validadorMensagem.validarMensagem(linhaProducao,linhaProducaoRepository,mensagemRepository,mensagemConsumo,validacaoParametrosMensagensServico);
        ...
        if (codigoDeposito!=null && materiaPrima != null) {
            try {
                operacoesUsoDeMaquina.adicionarMovimentosDeStock(mensagemConsumo.getQuantidadeProduzir(),materiaPrima,usoDeMaquina.movimentoStockList,codigoDeposito);
