...
import eapli.base.registarmaquina.aplication.LinhaProducaoDTO;
...
public class RegistarMaquinaUI extends AbstractUI {
    ...
    protected boolean doShow() {
        ...
        for(LinhaProducaoDTO linha : linhas){
            i++;
            System.out.println("Insira" + i +" para a linha com o identificador da linha de produção: "+linha.identificadorLinhaProducao);
        }
